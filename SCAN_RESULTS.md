...
|---------|-------|----------|------|--------|-----|---------|----------|--------|
| [atomicchonk/roadrecon_mcp_server](results/atomicchonk-roadrecon_mcp_server-violations.json) | 0 | 0 | 0 | 0 | 0 | 0 | osv-scanner, semgrep, trivy | 🟢 |
...
| [firstorderai/authenticator_mcp](results/firstorderai-authenticator_mcp-violations.json) | 3 | 0 | 2 | 1 | 0 | 2 | osv-scanner, semgrep, trivy | 🔴 |
